...
class CiscoBoot(BinaryView):
    ...
    def is_valid_for_data(self, data):
        ...
        if data[:12] == b'\xff\xff\xff\xff\xff\xff\xff\xffCI03':
            return True
        return False
    ...
    def init(self):
        try:
            ...
            self.add_auto_segment(0x1800000, 0x40000, 0x10, 0x2fd00, enums.SegmentFlag.SegmentExecutable | enums.SegmentFlag.SegmentReadable | enums.SegmentFlag.SegmentWritable )
            ...
            self.add_auto_section(".text", 0x1800000, 0x2b1c0, semantics=SectionSemantics.ReadOnlyCodeSectionSemantics)
            self.add_auto_section(".data", 0x182b1c0, 0x2fd00 - 0x2b1c0, semantics=SectionSemantics.ReadWriteDataSectionSemantics)
            self.add_auto_section(".bss", 0x182fd00, 0xf5d0, semantics=SectionSemantics.ReadWriteDataSectionSemantics)


            # add an entry point, like the one we happen to know exists at 0x1800b4c
            self.add_entry_point(0x1800b4c)
        except:
